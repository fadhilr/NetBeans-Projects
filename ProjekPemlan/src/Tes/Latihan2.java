...
public class Latihan2 extends Application{
    ...
    public void start(Stage stage){
        ...
        ImageView imgView = new ImageView(new Image(getClass().getResourceAsStream("tmpl.jpg"),  190, 190, true,true));
...
//        Pane.setRightAnchor(imgView,20.0);
    ...
    private Pane tab1(){
        ...
        HBox hb1 = new HBox();
        hb1.setStyle("-fx-border-weight: 2px;"
                + "-fx-border-color: red;");
        hb1.setSpacing(7);
        ...
        (new Image(getClass().getResourceAsStream("reverse.jpg"),30,30,true,true));
        HBox hbReverse = new HBox(ivReverse);
        hbReverse.setStyle("-fx-border-weight: 2px;"
                + "-fx-border-color: red;");
